...
},{"../actors/FilterBarActor":198,"../actors/TableActor":199,"../stores/FilterBarStore":228,"../stores/TableStore":229,"./FilterBar/FilterBar.react":204,"./Table/Table.react":226}],218:[function(require,module,exports){
"use strict";
    ...
    displaySelectableColumn: {
      value: function displaySelectableColumn() {
        if (this.context.tableStore.getSelectColumn() !== undefined) {
          ...
          return React.createElement(BodySelectable, { value: selectValue, reference: referenceValue });
        }
      }
    },
    render: {
...
},{"./BodyCell.react":219,"./BodySelectable.react":221}],221:[function(require,module,exports){
"use strict";
...
var BodySelectable = exports.BodySelectable = (function (_React$Component) {
  ...
  _createClass(BodySelectable, {
    addRemoveSelectedValue: {
      value: function addRemoveSelectedValue() {
        debugger;
        var input = this.refs[this.props.reference];
        var inputValue = input.value;
        selected_values = this.context.tableStore.getSelectedValues();
        selected_values.push(this.props.value);
        this.context.tableStore.setSelectedValues(selected_values);
      }
    },
    render: {
      value: function render() {
        return React.createElement(
          "th",
          null,
          React.createElement("input", { type: "checkbox", name: "select_all", value: this.props.value, ref: this.props.reference, onClick: this.addRemoveSelectedValue.bind(this) })
        );
      }
    }
  });
...
var HeadingRow = exports.HeadingRow = (function (_React$Component) {
  ...
  _createClass(HeadingRow, {
    displaySelectableColumn: {
      value: function displaySelectableColumn() {
        if (this.context.tableStore.getSelectColumn() !== undefined) {
          return React.createElement(HeadingSelectable, null);
        }
      }
    },
    render: {
...
},{"./HeadingCell.react":222,"./HeadingSelectable.react":224}],224:[function(require,module,exports){
"use strict";
...
},{"./Body.react":218,"./HeadingRow.react":223,"./Pagination.react":225}],227:[function(require,module,exports){
"use strict";
...
var TableStore = exports.TableStore = (function () {
  ...
  _createClass(TableStore, {
    ...
    getSelectColumn: {
      value: function getSelectColumn() {
