...
var FilterableJobsBoard = require("./components/FilterableJobsBoard.react").FilterableJobsBoard;
...
function configureFilterbar(configuration) {
  if (windowUrl().query(true).q !== "") {
    ...
    try {
      for (var _iterator = JSON.parse(windowUrl().query(true).q)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  React.render(React.createElement(FilterableJobsBoard, {
    filterBarConfiguration: configuration.filterBarConfiguration,
    jobsBoardConfiguration: configuration.jobsBoardConfiguration
  }), filterableJobsBoardNode);
});

},{"./components/FilterableJobsBoard.react":218,"./components/FilterableTable.react":219,"URIjs":4,"babel/polyfill":196}],2:[function(require,module,exports){
/*!
...
},{"../clients/SearchClient":202,"../helpers/URLHelper":235}],199:[function(require,module,exports){
"use strict";
...
var TableActor = require("./TableActor").TableActor;

var JobsBoardActor = exports.JobsBoardActor = (function (_TableActor) {
  function JobsBoardActor(filterBarStore, jobsBoardStore) {
    _classCallCheck(this, JobsBoardActor);

    this.filterBarStore = filterBarStore;
    this.tableStore = jobsBoardStore;
  }

  _inherits(JobsBoardActor, _TableActor);

  return JobsBoardActor;
})(TableActor);

},{"./TableActor":200}],200:[function(require,module,exports){
"use strict";
...
},{"../clients/SearchClient":202}],201:[function(require,module,exports){
"use strict";
...
},{"./ApplyFiltersButton.react":203,"./ClearFiltersButton.react":204,"./FilterDisplay/FilterDisplay.react":206,"./FilterList/FilterList.react":213,"./SaveFiltersButton.react":215,"./SavedSearchesList/SavedSearchesList.react":216}],206:[function(require,module,exports){
"use strict";
...
},{"./FilterInput.react":207}],207:[function(require,module,exports){
"use strict";
...
},{"./FilterInputFactory.react":208}],208:[function(require,module,exports){
"use strict";
...
},{"./Inputs/DateInput.react":209,"./Inputs/RangeInput.react":210,"./Inputs/SelectInput.react":211,"./Inputs/TextInput.react":212}],209:[function(require,module,exports){
"use strict";
...
},{"./FilterListOption.react":214}],214:[function(require,module,exports){
"use strict";
...
},{"./SavedSearchesListItem.react":217}],217:[function(require,module,exports){
"use strict";
...
var JobsBoardActor = require("../actors/JobsBoardActor").JobsBoardActor;

var FilterBarStore = require("../stores/FilterBarStore").FilterBarStore;

var JobsBoardStore = require("../stores/JobsBoardStore").JobsBoardStore;

var FilterBar = require("./FilterBar/FilterBar.react").FilterBar;

var JobsBoard = require("./JobsBoard/JobsBoard.react").JobsBoard;

var FilterableJobsBoard = exports.FilterableJobsBoard = (function (_React$Component) {
  function FilterableJobsBoard(props) {
    _classCallCheck(this, FilterableJobsBoard);

    _get(Object.getPrototypeOf(FilterableJobsBoard.prototype), "constructor", this).call(this, props);
  ...
  _inherits(FilterableJobsBoard, _React$Component);

  _createClass(FilterableJobsBoard, {
    getChildContext: {
    ...
    render: {
      value: function render() {
        return React.createElement(
          ...
          React.createElement(JobsBoard, null)
        );
      }
    }
  });

  return FilterableJobsBoard;
})(React.Component);
...
},{"../actors/FilterBarActor":198,"../actors/JobsBoardActor":199,"../stores/FilterBarStore":236,"../stores/JobsBoardStore":237,"./FilterBar/FilterBar.react":205,"./JobsBoard/JobsBoard.react":220}],219:[function(require,module,exports){
"use strict";
...
},{"../actors/FilterBarActor":198,"../actors/TableActor":200,"../stores/FilterBarStore":236,"../stores/TableStore":238,"./FilterBar/FilterBar.react":205,"./Table/Table.react":234}],220:[function(require,module,exports){
"use strict";
...
var JobsBoardRepeater = require("./JobsBoardRepeater.react").JobsBoardRepeater;

var Pagination = require("../Shared/Pagination.react").Pagination;

var SortPanel = require("./SortPanel.react").SortPanel;

var JobsBoard = exports.JobsBoard = (function (_React$Component) {
  function JobsBoard(props) {
    _classCallCheck(this, JobsBoard);

    _get(Object.getPrototypeOf(JobsBoard.prototype), "constructor", this).call(this, props);
    this.state = {
      currentPage: 1,
      totalPages: 1
    };
  ...
  _inherits(JobsBoard, _React$Component);

  _createClass(JobsBoard, {
    componentWillMount: {
      value: function componentWillMount() {
    ...
    render: {
      value: function render() {
        return React.createElement(
          "div",
          null,
          React.createElement(SortPanel, { cols: this.state.sortableColumns }),
          React.createElement(JobsBoardRepeater, {
...
},{"../Shared/Pagination.react":229,"./JobsBoardRepeater.react":222,"./SortPanel.react":227}],221:[function(require,module,exports){
"use strict";
...
var PanelHeading = require("./PanelHeading.react").PanelHeading;

var PanelBody = require("./PanelBody.react").PanelBody;

var JobsBoardPanel = exports.JobsBoardPanel = (function (_React$Component) {
  function JobsBoardPanel(props) {
    _classCallCheck(this, JobsBoardPanel);

    _get(Object.getPrototypeOf(JobsBoardPanel.prototype), "constructor", this).call(this, props);
  }

  _inherits(JobsBoardPanel, _React$Component);

  _createClass(JobsBoardPanel, {
    render: {
      value: function render() {
        return React.createElement(
          "div",
          { className: "panel panel-default" },
          React.createElement(PanelHeading, { cells: this.props.cells, header: this.props.header }),
          React.createElement(PanelBody, { cells: this.props.cells, body: this.props.body })
        );
      }
    }
  });

  return JobsBoardPanel;
})(React.Component);
...
},{"./PanelBody.react":223,"./PanelHeading.react":226}],222:[function(require,module,exports){
"use strict";
...
var JobsBoardPanel = require("./JobsBoardPanel.react").JobsBoardPanel;

var JobsBoardRepeater = exports.JobsBoardRepeater = (function (_React$Component) {
  function JobsBoardRepeater(props) {
    _classCallCheck(this, JobsBoardRepeater);

    _get(Object.getPrototypeOf(JobsBoardRepeater.prototype), "constructor", this).call(this, props);
  }

  _inherits(JobsBoardRepeater, _React$Component);

  _createClass(JobsBoardRepeater, {
    render: {
      value: function render() {
        var rows = this.props.rows.map(function (cells, index) {
          return React.createElement(JobsBoardPanel, { key: index, cells: cells, header: this.props.header, body: this.props.body });
        }, this);
        return React.createElement(
          "div",
          null,
...
},{"./JobsBoardPanel.react":221}],223:[function(require,module,exports){
"use strict";
...
var PanelBodyLeftSide = require("./PanelBodyLeftSide.react").PanelBodyLeftSide;

var PanelBodyRightSide = require("./PanelBodyRightSide.react").PanelBodyRightSide;

var PanelBody = exports.PanelBody = (function (_React$Component) {
  function PanelBody(props) {
    _classCallCheck(this, PanelBody);

    _get(Object.getPrototypeOf(PanelBody.prototype), "constructor", this).call(this, props);
  }
    ...
    render: {
      value: function render() {
        ...
        var leftSideContent = Object.values(this.props.body.leftSide).map(function (leftSideDetails, index) {
          return React.createElement(PanelBodyLeftSide, { cells: this.props.cells, details: leftSideDetails, key: index });
        }, this);

        var rightSideContent = Object.values(this.props.body.rightSide).map(function (rightSideDetails, index) {
          return React.createElement(PanelBodyRightSide, { cells: this.props.cells, details: rightSideDetails, key: index });
        }, this);
...
},{"./PanelBodyLeftSide.react":224,"./PanelBodyRightSide.react":225}],224:[function(require,module,exports){
"use strict";
...
var PanelBodyLeftSide = exports.PanelBodyLeftSide = (function (_React$Component) {
  function PanelBodyLeftSide(props) {
    _classCallCheck(this, PanelBodyLeftSide);

    _get(Object.getPrototypeOf(PanelBodyLeftSide.prototype), "constructor", this).call(this, props);
  }

  _inherits(PanelBodyLeftSide, _React$Component);

  _createClass(PanelBodyLeftSide, {
    render: {
      value: function render() {
        return React.createElement(
          "div",
          { className: "row margin-bottom-md" },
          React.createElement(
            "div",
            { className: "col-md-12" },
            React.createElement(
            ...
            React.createElement("div", { dangerouslySetInnerHTML: { __html: this.props.cells[this.props.details.content] } })
          )
        );
      }
    }
...
var PanelBodyRightSide = exports.PanelBodyRightSide = (function (_React$Component) {
  function PanelBodyRightSide(props) {
    _classCallCheck(this, PanelBodyRightSide);

    _get(Object.getPrototypeOf(PanelBodyRightSide.prototype), "constructor", this).call(this, props);
  }

  _inherits(PanelBodyRightSide, _React$Component);

  _createClass(PanelBodyRightSide, {
    render: {
      value: function render() {
        return React.createElement(
          "div",
...
var PanelHeading = exports.PanelHeading = (function (_React$Component) {
  function PanelHeading(props) {
    _classCallCheck(this, PanelHeading);

    _get(Object.getPrototypeOf(PanelHeading.prototype), "constructor", this).call(this, props);
  }
    ...
    render: {
      value: function render() {
        ...
        var details = Object.keys(this.props.header.details).map(function (detail, index) {
          return React.createElement("div", { key: index, className: detailsClassName, dangerouslySetInnerHTML: { __html: this.props.cells[detail] } });
        }, this);

        var titleContent = this.props.cells[this.props.header.title];
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              { className: "col-md-6" },
              React.createElement("i", { className: "icon icon-interview heading-icon" }),
              React.createElement("span", { dangerouslySetInnerHTML: { __html: titleContent } })
            ),
            React.createElement(
              "div",
              { className: "col-md-6" },
...
var HeadingCell = require("../Shared/HeadingCell.react").HeadingCell;

var SortPanel = exports.SortPanel = (function (_React$Component) {
  function SortPanel(props) {
    _classCallCheck(this, SortPanel);

    _get(Object.getPrototypeOf(SortPanel.prototype), "constructor", this).call(this, props);
  }

  _inherits(SortPanel, _React$Component);
...
},{"../Shared/HeadingCell.react":228}],228:[function(require,module,exports){
"use strict";
...
},{"./BodyRow.react":232}],231:[function(require,module,exports){
"use strict";
...
},{"./BodyCell.react":231}],233:[function(require,module,exports){
"use strict";
...
},{"../Shared/HeadingCell.react":228}],234:[function(require,module,exports){
"use strict";
...
},{"../Shared/Pagination.react":229,"./Body.react":230,"./HeadingRow.react":233}],235:[function(require,module,exports){
"use strict";
...
},{"../clients/FilterClient":201,"../clients/SearchClient":202}],237:[function(require,module,exports){
"use strict";
...
var TableStore = require("./TableStore").TableStore;

var JobsBoardStore = exports.JobsBoardStore = (function (_TableStore) {
  function JobsBoardStore(configuration) {
    _classCallCheck(this, JobsBoardStore);

    _get(Object.getPrototypeOf(JobsBoardStore.prototype), "constructor", this).call(this, configuration);
  ...
  _inherits(JobsBoardStore, _TableStore);

  _createClass(JobsBoardStore, {
    getHeader: {
    ...
    getSortableColumns: {
      value: function getSortableColumns() {
        return this.sortableColumns;
      }
    }
  });

  return JobsBoardStore;
})(TableStore);

},{"./TableStore":238}],238:[function(require,module,exports){
"use strict";
